...
const Home = () => {
    ...
    return (
        <div>
            <div className='container min-vh-100 d-flex flex-column justify-content-center align-items-center text-white'>
                ...
                <div className='d-flex justify-content-between align-items-center w-100 mx-auto mt-5'>
                    <div className='d-flex flex-column justify-content-between'>
                        ...
                        <a href="https://github.com/MahfujAhsan" target="_blank" className='text-decoration-none text-white'><FontAwesomeIcon icon={faGithub} size="xl" className='my-3' /></a>
                        ...
                        <span className='text-center mt-2 fs-3'>|</span>

                    </div>
                    <img className='w-50 mx-auto rounded-3' src={profile} alt="" />
                    <div role="button" className='d-flex flex-column justify-content-end align-items-end fs-6 font-monospace lh-1'>
                        <span>S</span>
                        <span>c</span>
                        <span>r</span>
                        <span>o</span>
